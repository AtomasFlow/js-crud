...
router.post('/product-create', (req, res) => {
  const { name, price, description } = req.body;
	...
	if (!name || !price || !description) {
		return res.render('product/product-alert', {
			style: 'product/product-alert',
  ...
  res.render('product/product-alert', {
		style: 'product/product-alert',
